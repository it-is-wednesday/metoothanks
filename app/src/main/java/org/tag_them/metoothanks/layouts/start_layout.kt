    ...
    override fun createView(ui: AnkoContext<Welcome>): View = with(ui) {
        ...
        relativeLayout {
            ...
            empty_canvas_button = button("empty canvas") {
                ...
                setPadding(BUTTON_PADDING_HORIZONTAL, BUTTON_PADDING_VERTICAL,
            ...
            val updateNotifier = button(R.string.update_checking) {
            ...
            VersionCheck(WeakReference(updateNotifier)).execute(
                    "https://github.com/tag-them/metoothanks/releases")
        }
    }

    companion object {
        class VersionCheck(private val button: WeakReference<Button>) :
